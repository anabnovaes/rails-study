...
Product.create!(title: 'Build Chatbot Interactions',
  description:
    %{<p>
      <em> Resonsive, Intuitive Interfaces with Ruby </em>
  ...
  image_url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEw54dj4yVbZVcznvYk3Jj1Ypm-4t3tx2MGKa8L_2zZmBKWuCxZjXbpvu4iX9Uk2IKLA4&usqp=CAU',
  price: 20.00)
# . . .
